# 🌙 SleepMonitor · 智能睡眠监测 App（高保真原型）

> 一个面向「智能睡眠监测」场景的移动端高保真交互原型，使用 **React + TypeScript + Vite** 实现，可真实运行、可手势交互，用于演示产品功能框架与交互细节。
>
> 本项目对应简历中的「智能睡眠监测 APP UI 开发」经历，覆盖从原型设计、架构搭建到体验迭代的完整闭环。
...
## 🔧 体验迭代（基于试用反馈修复 10+ 体验问题）

> 项目在内部试用阶段收集反馈，累计定位并修复 **12** 项体验问题，节选如下：
